...
class ScRNASeqData:
    def __init__(
        ...
        #Mapping expression values to levels 1-15
        ...
        #Expression data normalised gene_id cell_id Expression value
        ...
        #Returns the index position of level on a scale of 1-15
    ...
    def build_bin_normalized_matrix(self, data):
        ...
        new_data_dict = {}
        new_data_rpkm_dict = {}
        #mask removes expressions with a value of 0
...
class GeneData:
    def __init__(self, rpkm_path, label_path, divide_path, TF_num, gene_emb_path,
    ...
    def getLabel(self, label_path):
        ...
        for line in s:
            ...
            if key not in self.HNS_list.keys():
                self.HNS_list[key] = int(label)
        ...
        for i in range(TF_num):
            ...
            for line in self.key_list[start_idx:end_idx]:
                ...
                if int(label) != 2:
                    ...
                    gene_emb = np.concatenate((gene1_emb, gene2_emb), axis=0)

...
def config():
    ...
    parser.add_argument(
        ...
        default="mDC1000",
        type=str,
        help="The dataset name: mHSC_E, mHSC_GM, mHSC_L, timeData/mDC1...",
    )
    parser.add_argument(
        "--expression_path",
    ...
    parser.add_argument(
        "--label_path",
        default="./dataset/mDC/TFs+1000/mDC1000shuffled_output.txt",
        type=str,
        
    )
    parser.add_argument(
        "--divide_path",
        default="./dataset/mDC/TFs+1000/mDC1000_divide.txt",
        type=str,
    ...
    parser.add_argument(
        "--gene_list_path",
        default="./dataset/mDC/TFs+1000/mDC1000_MAP_NAME.txt",
        type=str,
    )

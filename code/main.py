...
def config():
    ...
    parser.add_argument(
        "--expression_path",
        default="./dataset/mHSC-L/TFs+500/BL--ExpressionData.csv",
        type=str,
    )
    parser.add_argument(
        "--label_path",
        default="./dataset/mHSC-L/TFs+500/mHSC-L500shuffled_output.txt",
        type=str,
    )
    parser.add_argument(
        "--divide_path",
        default="./dataset/mHSC-L/TFs+500/mHSC-L500_divide.txt",
        type=str,
    ) 
#mHSC-GM1000 10 mHSC-L1000 6 mHSC-E1000 12 hESC1000 15 hHEP1000 14 mDC 10 mESC1000 14
#mHSC-GM 8 mHSC-L 4 mHSC-E 7 hESC 7 hHEP 10 mDC 9 mESC 12
    parser.add_argument(
        "--TF_num",
        default=4,
        type=int,
    ...
    parser.add_argument(
        "--gene_list_path",
        default="./dataset/mHSC-L/TFs+500/mHSC-L500_MAP_NAME.txt",
        type=str,
    )
